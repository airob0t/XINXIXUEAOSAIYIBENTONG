...
<h3>【输入】</h3>
<p>第一行是一个整数T，代表一共有多少组数据。1≤T≤100</p><p>
接下来是T组数据。</p><p>
每组数据的第一行是两个整数，分别代表花生苗的行数R和列数 C(1≤R,C≤100)</p><p>
每组数据的接下来R行数据，从北向南依次描述每行花生苗的情况。每行数据有C个整数，按从西向东的顺序描述了该行每株花生苗上的花生数目M(0≤M≤1000)。</p><p>
</p>
<h3>【输出】</h3>
...
16</pre></div><font size="2"><h3>【来源】</h3><br/><font size="2"><a class="bottom_link" href="problem_search.php?searchsource=No">No</a><p align="center"> <a class="bottom_link" href="submit.php?pid=1284"> 提交 </a> <a class="bottom_link" href="problem_stat.php?pid=1284"> 统计信息 </a> </p></font></font></font></font></font></font></td></table>